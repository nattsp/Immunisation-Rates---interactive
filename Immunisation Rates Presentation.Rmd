...
This app provides a simple way to see how different types of immunisations are taken up in the comunity when compared to the total immunisation rates.  You can also see the variance over time in different regions in Australia.

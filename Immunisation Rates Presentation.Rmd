...
This app provides a simple way to see how different types of immunisations are taken up when compared to the total immunisation rates.  You can also see the variance over time in different regions in Australia.

To do this we have leveraged publicly available immunisation data from the government.
...
All eight spreadsheets are then read into a single dataframe noting the unique "date of processing" of each file. This data is now ready for use and further refinement in the shiny app.
